...
<head>
    ...
    <title>Адмін панель | StandBlog</title>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.index') }}" class="nav-link">Головна</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
        ...
        <form class="form-inline ml-3" method="GET" action="{{ route('admin.search') }}">
            ...
            <div class="input-group input-group-sm">
                <input class="form-control form-control-navbar @error('q')is-invalid @enderror" type="search" name="q"
                       placeholder="@if($errors->any()){{$errors->first('q')}}
                       @elseПошук@endif" aria-label="Search">
